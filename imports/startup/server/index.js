...
// Configure Browser Policy for Content Security Policy
BrowserPolicy.content.disallowInlineScripts()
BrowserPolicy.content.disallowEval()
// NOTE: allowInlineStyles adds 'unsafe-inline' to style-src. Required because jQuery
// .show()/.hide() and numerous template elements use inline style attributes.
// TODO: Migrate inline styles to CSS classes and remove this directive.
BrowserPolicy.content.allowInlineStyles()
BrowserPolicy.content.allowFontDataUrl()

// Allow only the specific CDN hosts used by pinned, SRI-protected resources:
//   cdn.jsdelivr.net  — hack-font, jdenticon, apexcharts
...
BrowserPolicy.content.allowFontOrigin("'self'")
BrowserPolicy.content.allowImageOrigin("'self'")
BrowserPolicy.content.allowConnectOrigin("'self'")

// Allow only required external API connections
BrowserPolicy.content.allowConnectOrigin('https://market-data.automated.theqrl.org')
BrowserPolicy.content.allowConnectOrigin('https://richlist-api.theqrl.org')
